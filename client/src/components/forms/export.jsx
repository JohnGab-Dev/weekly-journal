...
function ExportReport() {
    ...
    const fetchPreference = async () => {
        const res = api.get(`get-preference?id=${id}`)
    }
    ...
    const onSubmit = async (data) => {
        ...
        const response = await exportReport(data)
  ...
  return (
    <div className="bg-white rounded-xl">
        <div className="p-6 border-b">   
            <h1 className="text-xl font-semibold">Export your report</h1>
            <h2 className="text-sm text-gray-700">Please fill in all fields to complete the export</h2>
        </div>
