...
import { AddTask } from "@/services/StudentServices"
import toast from 'react-hot-toast'

export function AddModal({ openAdd, setOpenAdd, fetchTaskEvents }) {
    ...
    <Dialog  open={openAdd} onOpenChange={setOpenAdd}>
        <DialogContent className="sm:max-w-lg">
          ...
          <DialogFooter className='mt-4'>
            ...
            <Button type="submit" disabled={loading}>{loading ? "Adding..." : "Add Report"}</Button>
          </DialogFooter>
          </form>
        </DialogContent>
